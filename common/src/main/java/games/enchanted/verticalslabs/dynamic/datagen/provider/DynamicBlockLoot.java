...
public class DynamicBlockLoot extends BlockLootSubProvider {
    static ResourceKey<LootTable> RESOURCE_KEY = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(EnchantedVerticalSlabsConstants.LEGACY_RESOURCE_LOCATION, "blocks"));
