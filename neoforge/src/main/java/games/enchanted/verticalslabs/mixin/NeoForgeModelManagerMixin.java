...
public abstract class NeoForgeModelManagerMixin {
    ...
    private static void evs$suppressMissingModelWarningsConditionally(Logger instance, String logMessage, Object object, Operation<Void> original) {
        ...
        if(!DynamicResourcePackManager.hasBeenInitialised() && modelLocation.id().getNamespace().equals(EnchantedVerticalSlabsConstants.LEGACY_RESOURCE_LOCATION)) {
            return;
        }
        original.call(instance, logMessage, object);
    }
